...
double d1p(int i,int j,int f, int t)
{
      return  (8.0*X[i+1% n_max + n_max) %n_max][j][f][t]-8.0*X[i-1% n_max + n_max) %n_max][j][f][t]-X[i+2% n_max + n_max) %n_max][j][f][t]+X[i-2% n_max + n_max) %n_max][j][f][t])/(12.0*delta_x);
    
}

double d2p(int i,int j,int f, int t)
{
      return (8.0*X[i][j+1% n_max + n_max) %n_max][f][t]-8.0*X[i][j-1% n_max + n_max) %n_max][f][t]-X[i][j+2% n_max + n_max) %n_max][f][t]+X[i][j-2% n_max + n_max) %n_max][f][t])/(12.0*delta_x);
...
double d11p(int i,int j,int f, int t)
{
      return (16.0*X[i+1% n_max + n_max) %n_max][j][f][t]+16.0*X[i-1% n_max + n_max) %n_max][j][f][t]-30.0*X[i][j][f][t]-X[i+2% n_max + n_max) %n_max][j][f][t]-X[i-2% n_max + n_max) %n_max][j][f][t])/(12.0*pow(delta_x,2));
    
}

double  d22p(int i,int j,int f, int t)
{
       return (16.0*X[i][j+1% n_max + n_max) %n_max][f][t]+16.0*X[i][j-1% n_max + n_max) %n_max][f][t]-30.0*X[i][j][f][t]-X[i][j+2% n_max + n_max) %n_max][f][t]-X[i][j-2% n_max + n_max) %n_max][f][t])/(12.0*pow(delta_x,2));
     
}
//----Y field derivatives ---
double d1y(int i,int j,int f, int t)
{
      return  (8.0*Y[i+1% n_max + n_max) %n_max][j][f][t]-8.0*Y[i-1% n_max + n_max) %n_max][j][f][t]-Y[i+2% n_max + n_max) %n_max][j][f][t]+Y[i-2% n_max + n_max) %n_max][j][f][t])/(12.0*delta_x);
   
}

double d2y(int i,int j,int f, int t)
{
      return (8.0*Y[i][j+1% n_max + n_max) %n_max][f][t]-8.0*Y[i][j-1% n_max + n_max) %n_max][f][t]-Y[i][j+2% n_max + n_max) %n_max][f][t]+Y[i][j-2% n_max + n_max) %n_max][f][t])/(12.0*delta_x);
...
double d11y(int i,int j,int f, int t)
{
      ...
      return (16.0*Y[i+1% n_max + n_max) %n_max][j][f][t]+16.0*Y[i-1% n_max + n_max) %n_max][j][f][t]-30.0*Y[i][j][f][t]-Y[i+2% n_max + n_max) %n_max][j][f][t]-Y[i-2% n_max + n_max) %n_max][j][f][t])/(12.0*pow(delta_x,2));
    
}

double  d22y(int i,int j,int f, int t)
{
       return (16.0*Y[i][j+1% n_max + n_max) %n_max][f][t]+16.0*Y[i][j-1% n_max + n_max) %n_max][f][t]-30.0*Y[i][j][f][t]-Y[i][j+2% n_max + n_max) %n_max][f][t]-Y[i][j-2% n_max + n_max) %n_max][f][t])/(12.0*pow(delta_x,2));
